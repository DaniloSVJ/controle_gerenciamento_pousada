    ...
    public partial class FrmReservas : Form
    {
        ...
        private void verificarOcupacoes()
        {
            ...
            for (int i = 1; i <= diasMes; i += 1)
            {
                if (i < 10)
                {
                        ...
                        data = 0 + i.ToString() + "/" + cbMes.Text + "/" +Convert.ToString(DateTime.Now.Year);
                    
                    
                }
                else
                {
                     data = i + "/" + cbMes.Text + "/" +Convert.ToString(DateTime.Now.Year);
        ...
        private void Panel3_Click(object sender, EventArgs e)
        {
            if (mes < 10){
                ...
                dataPainel = lbl03.Text + "/0" + cbMes.Text + "/" +Convert.ToString(DateTime.Now.Year);
                }
            else
            {
                dataPainel = lbl03.Text + "/" + cbMes.Text + "/" +Convert.ToString(DateTime.Now.Year);
             }
            SalvarOcupacao();
        ...
        private void Panel2_Click(object sender, EventArgs e)
        {
            if (mes < 10)
            {
                dataPainel = lbl02.Text + "/" + cbMes.Text + "/" +Convert.ToString(DateTime.Now.Year);
            }
            else
            {
                dataPainel = lbl02.Text + "/" + cbMes.Text + "/" +Convert.ToString(DateTime.Now.Year);
        ...
        private void Panel1_Click(object sender, EventArgs e)
        {
            if (mes < 10)
            {
                dataPainel = lbl01.Text + "/" + cbMes.Text + "/" +Convert.ToString(DateTime.Now.Year);
            }
            else
            {
                dataPainel = lbl01.Text + "/" + cbMes.Text + "/" +Convert.ToString(DateTime.Now.Year);
        ...
        private void Panel4_Click(object sender, EventArgs e)
        {
            if (mes < 10)
            {
                ...
                dataPainel = lbl04.Text + "/" + cbMes.Text + "/" + Convert.ToString(DateTime.Now.Year);
            }
            else
            {
                dataPainel = lbl04.Text + "/" + cbMes.Text + "/" +Convert.ToString(DateTime.Now.Year);
        ...
        private void Panel5_Click(object sender, EventArgs e)
        {
            if (mes < 10)
            {
                dataPainel = lbl05.Text + "/" + cbMes.Text + "/" +Convert.ToString(DateTime.Now.Year);
            }
            else
            {
                dataPainel = lbl05.Text + "/" + cbMes.Text + "/" +Convert.ToString(DateTime.Now.Year);
        ...
        private void Panel6_Click(object sender, EventArgs e)
        {
            if (mes < 10)
            {
                dataPainel = lbl06.Text + "/" + cbMes.Text + "/" +Convert.ToString(DateTime.Now.Year);
            }
            else
            {
                dataPainel = lbl06.Text + "/" + cbMes.Text + "/" +Convert.ToString(DateTime.Now.Year);
        ...
        private void Panel7_Click(object sender, EventArgs e)
        {
            if (mes < 10)
            {
                dataPainel = lbl07.Text + "/" + cbMes.Text + "/" +Convert.ToString(DateTime.Now.Year);
            }
            else
            {
                dataPainel = lbl07.Text + "/" + cbMes.Text + "/" +Convert.ToString(DateTime.Now.Year);
        ...
        private void Panel8_Click(object sender, EventArgs e)
        {
            if (mes < 10)
            {
                dataPainel = lbl08.Text + "/" + cbMes.Text + "/" +Convert.ToString(DateTime.Now.Year);
            }
            else
            {
                dataPainel = lbl08.Text + "/" + cbMes.Text + "/" +Convert.ToString(DateTime.Now.Year);
        ...
        private void Panel9_Click(object sender, EventArgs e)
        {
            if (mes < 10)
            {
                dataPainel = lbl09.Text + "/" + cbMes.Text + "/" +Convert.ToString(DateTime.Now.Year);
            }
            else
            {
                dataPainel = lbl09.Text + "/" + cbMes.Text + "/" +Convert.ToString(DateTime.Now.Year);
        ...
        private void Lbl10_Click(object sender, EventArgs e)
        {
            if (mes < 10)
            {
                dataPainel = lbl10.Text + "/" + cbMes.Text + "/" +Convert.ToString(DateTime.Now.Year);
            }
            else
            {
                dataPainel = lbl10.Text + "/" + cbMes.Text + "/" +Convert.ToString(DateTime.Now.Year);
        ...
        private void Lbl11_Click(object sender, EventArgs e)
        {
            if (mes < 10)
            {
                dataPainel = lbl11.Text + "/" + cbMes.Text + "/" +Convert.ToString(DateTime.Now.Year);
            }
            else
            {
                dataPainel = lbl11.Text + "/" + cbMes.Text + "/" +Convert.ToString(DateTime.Now.Year);
        ...
        private void Panel12_Click(object sender, EventArgs e)
        {
            if (mes < 10)
            {
                dataPainel = lbl12.Text + "/" + cbMes.Text + "/" +Convert.ToString(DateTime.Now.Year);
            }
            else
            {
                dataPainel = lbl12.Text + "/" + cbMes.Text + "/" +Convert.ToString(DateTime.Now.Year);
        ...
        private void Lbl13_Click(object sender, EventArgs e)
        {
            if (mes < 10)
            {
                dataPainel = lbl13.Text + "/" + cbMes.Text + "/" +Convert.ToString(DateTime.Now.Year);
            }
            else
            {
                dataPainel = lbl13.Text + "/" + cbMes.Text + "/" +Convert.ToString(DateTime.Now.Year);
        ...
        private void Panel14_Click(object sender, EventArgs e)
        {
            if (mes < 10)
            {
                dataPainel = lbl14.Text + "/" + cbMes.Text + "/" +Convert.ToString(DateTime.Now.Year);
            }
            else
            {
                dataPainel = lbl14.Text + "/" + cbMes.Text + "/" +Convert.ToString(DateTime.Now.Year);
        ...
        private void Lbl15_Click(object sender, EventArgs e)
        {
            if (mes < 10)
            {
                dataPainel = lbl15.Text + "/" + cbMes.Text + "/" +Convert.ToString(DateTime.Now.Year);
            }
            else
            {
                dataPainel = lbl15.Text + "/" + cbMes.Text + "/" +Convert.ToString(DateTime.Now.Year);
        ...
        private void Panel16_Click(object sender, EventArgs e)
        {
            if (mes < 10)
            {
                dataPainel = lbl16.Text + "/" + cbMes.Text + "/" +Convert.ToString(DateTime.Now.Year);
            }
            else
            {
                dataPainel = lbl16.Text + "/" + cbMes.Text + "/" +Convert.ToString(DateTime.Now.Year);
        ...
        private void Panel17_Click(object sender, EventArgs e)
        {
            if (mes < 10)
            {
                dataPainel = lbl17.Text + "/" + cbMes.Text + "/" +Convert.ToString(DateTime.Now.Year);
            }
            else
            {
                dataPainel = lbl17.Text + "/" + cbMes.Text + "/" +Convert.ToString(DateTime.Now.Year);
        ...
        private void Panel18_Click(object sender, EventArgs e)
        {
            if (mes < 10)
            {
                dataPainel = lbl18.Text + "/" + cbMes.Text + "/" +Convert.ToString(DateTime.Now.Year);
            }
            else
            {
                dataPainel = lbl18.Text + "/" + cbMes.Text + "/" +Convert.ToString(DateTime.Now.Year);
        ...
        private void Panel19_Click(object sender, EventArgs e)
        {
            if (mes < 10)
            {
                dataPainel = lbl19.Text + "/" + cbMes.Text + "/" +Convert.ToString(DateTime.Now.Year);
            }
            else
            {
                dataPainel = lbl19.Text + "/" + cbMes.Text + "/" +Convert.ToString(DateTime.Now.Year);
        ...
        private void Panel20_Click(object sender, EventArgs e)
        {
            if (mes < 10)
            {
                dataPainel = lbl20.Text + "/" + cbMes.Text + "/" +Convert.ToString(DateTime.Now.Year);
            }
            else
            {
                dataPainel = lbl20.Text + "/" + cbMes.Text + "/" +Convert.ToString(DateTime.Now.Year);
        ...
        private void Panel21_Click(object sender, EventArgs e)
        {
            if (mes < 10)
            {
                dataPainel = lbl21.Text + "/" + cbMes.Text + "/" +Convert.ToString(DateTime.Now.Year);
            }
            else
            {
                dataPainel = lbl21.Text + "/" + cbMes.Text + "/" +Convert.ToString(DateTime.Now.Year);
        ...
        private void Panel22_Click(object sender, EventArgs e)
        {
            if (mes < 10)
            {
                dataPainel = lbl22.Text + "/" + cbMes.Text + "/" +Convert.ToString(DateTime.Now.Year);
            }
            else
            {
                dataPainel = lbl22.Text + "/" + cbMes.Text + "/" +Convert.ToString(DateTime.Now.Year);
        ...
        private void Panel23_Click(object sender, EventArgs e)
        {
            if (mes < 10)
            {
                dataPainel = lbl23.Text + "/" + cbMes.Text + "/" +Convert.ToString(DateTime.Now.Year);
            }
            else
            {
                dataPainel = lbl23.Text + "/" + cbMes.Text + "/" +Convert.ToString(DateTime.Now.Year);
        ...
        private void Panel24_Click(object sender, EventArgs e)
        {
            if (mes < 10)
            {
                dataPainel = lbl24.Text + "/" + cbMes.Text + "/" +Convert.ToString(DateTime.Now.Year);
            }
            else
            {
                dataPainel = lbl24.Text + "/" + cbMes.Text + "/" +Convert.ToString(DateTime.Now.Year);
        ...
        private void Panel25_Click(object sender, EventArgs e)
        {
            if (mes < 10)
            {
                dataPainel = lbl25.Text + "/" + cbMes.Text + "/" +Convert.ToString(DateTime.Now.Year);
            }
            else
            {
                dataPainel = lbl25.Text + "/" + cbMes.Text + "/" +Convert.ToString(DateTime.Now.Year);
        ...
        private void Panel26_Click(object sender, EventArgs e)
        {
            if (mes < 10)
            {
                dataPainel = lbl26.Text + "/" + cbMes.Text + "/" +Convert.ToString(DateTime.Now.Year);
            }
            else
            {
                dataPainel = lbl26.Text + "/" + cbMes.Text + "/" +Convert.ToString(DateTime.Now.Year);
        ...
        private void Panel27_Click(object sender, EventArgs e)
        {
            if (mes < 10)
            {
                dataPainel = lbl27.Text + "/" + cbMes.Text + "/" +Convert.ToString(DateTime.Now.Year);
            }
            else
            {
                dataPainel = lbl27.Text + "/" + cbMes.Text + "/" +Convert.ToString(DateTime.Now.Year);
        ...
        private void Panel28_Click(object sender, EventArgs e)
        {
            if (mes < 10)
            {
                dataPainel = lbl28.Text + "/" + cbMes.Text + "/" +Convert.ToString(DateTime.Now.Year);
            }
            else
            {
                dataPainel = lbl28.Text + "/" + cbMes.Text + "/" +Convert.ToString(DateTime.Now.Year);
        ...
        private void Panel29_Click(object sender, EventArgs e)
        {
            if (mes < 10)
            {
                dataPainel = lbl29.Text + "/" + cbMes.Text + "/" +Convert.ToString(DateTime.Now.Year);
            }
            else
            {
                dataPainel = lbl29.Text + "/" + cbMes.Text + "/" +Convert.ToString(DateTime.Now.Year);
        ...
        private void Panel30_Click(object sender, EventArgs e)
        {
            if (mes < 10)
            {
                dataPainel = lbl30.Text + "/" + cbMes.Text + "/" +Convert.ToString(DateTime.Now.Year);
            }
            else
            {
                dataPainel = lbl30.Text + "/" + cbMes.Text + "/" +Convert.ToString(DateTime.Now.Year);
        ...
        private void Panel31_Click(object sender, EventArgs e)
        {
            if (mes < 10)
            {
                dataPainel = lbl31.Text + "/" + cbMes.Text + "/" +Convert.ToString(DateTime.Now.Year);
            }
            else
            {
                dataPainel = lbl31.Text + "/" + cbMes.Text + "/" +Convert.ToString(DateTime.Now.Year);
